...
同时，我们的 $\sin x,\cos x$ 都可以解决.$$\sin x=2\sin \frac{x}{2}\cos \frac{x}{2}= \frac{\left( 2\sin \frac{x}{2}\cos \frac{x}{2} \right)}{\sin ^{2} \frac{x}{2}+\cos ^{2} \frac{x}{2}}=\frac{2t}{t^{2}+1}$$
...
$$\begin{align}原式=\int \frac{\cos ^{2}x-2}{1+\sin ^{2}x+\sin^4}\mathrm{d}(\sin x)\\ \\=-\int \frac{1+\sin ^{2}x}{1+\sin ^{2}x+\sin^4x}d(\sin x)\\ \\\end{align}$$
